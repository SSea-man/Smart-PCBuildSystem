    ...
    <div class="container-xl">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="hero-tag">
                    <span class="d-inline-block animate-pulse"
                ...
                <p class="hero-desc">
                    PCBuilder BD is a smart custom build platform designed to transform complex hardware data into
                    clear, compatible, and actionable setups.
                </p>

                <div class="mb-4 mt-2" style="max-width: 500px;">
                    <form action="<?= BASE_URL ?>/store.php" method="GET" class="search-box-container">
                        <div class="input-group search-input-group">
                            <span class="input-group-text search-icon-btn"><i
                                    class="bi bi-search text-accent"></i></span>
                            <input type="text" name="search" class="form-control search-input"
                                placeholder="Search 165+ components (e.g., RTX 4070, Ryzen 5)..." required>
            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="hero-img-container">
                    <img src="<?= BASE_URL ?>/assets/img/exploded_pc.png" alt="Exploded PC Render"
                        class="img-fluid hero-img-light hero-img-blend">
                    <img src="<?= BASE_URL ?>/assets/img/exploded_pc_dark.png" alt="Exploded PC Render Dark"
                        class="img-fluid hero-img-dark hero-img-blend">
                </div>
            </div>
                ...
                <div class="card floating-widget-card p-3 border-0">
                    ...
                    <div style="height: 80px; width: 100%;">
                        <svg viewBox="0 0 100 30" class="w-100 h-100" preserveAspectRatio="none">
                            ...
                            <path d="M 0,25 Q 15,10 30,18 T 60,8 T 90,15 L 100,5 L 100,30 L 0,30 Z"
                                fill="url(#sparkGradient)"></path>
                            <path d="M 0,25 Q 15,10 30,18 T 60,8 T 90,15 L 100,5" fill="none" stroke="var(--accent)"
                                stroke-width="2" stroke-linecap="round"></path>
                            <circle cx="100" cy="5" r="3" fill="var(--accent)"></circle>
                        </svg>
                    </div>
                    <div
                        class="d-flex justify-content-between mt-2 pt-2 border-top border-light-custom small text-muted">
                        ...
                        <div class="position-relative" style="width: 76px; height: 76px; flex-shrink: 0;">
                            <svg viewBox="0 0 36 36" class="w-100 h-100" style="transform: rotate(-90deg);">
                                <path class="gauge-bg"
                                    ...
                                    fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="3"></path>
                                <path class="gauge-fill"
                                    d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                                    fill="none" stroke="var(--accent)" stroke-width="3" stroke-dasharray="98, 100">
                                </path>
                            </svg>
                            <div class="position-absolute top-50 start-50 translate-middle text-center">
                                <div class="fw-800 small text-accent" style="font-size: 0.85rem; line-height: 1;">98%
                                </div>
                                <small class="text-muted"
                                    style="font-size: 0.55rem; display: block; line-height: 1;">Match</small>
                            </div>
                        </div>
    ...
    <div class="container-xl">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <?php else: ?>
                <a href="<?= BASE_URL ?>/login.php" class="btn btn-configure text-decoration-none">Log in to
                    Configure</a>
                <?php endif; ?>
            </div>

            <div class="col-lg-5 col-md-6 text-center">
                <img src="<?= BASE_URL ?>/assets/img/brand_new_beast.png" alt="Brand New Beast PC" class="img-fluid"
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <a href="<?= BASE_URL ?>/store.php?category=Case" class="text-decoration-none">
                    <div class="component-card-custom">
                        <img src="<?= BASE_URL ?>/assets/img/cat_peripherals.png" alt="Gaming Peripherals"
                            class="img-fluid">
    ...
    <div class="container-xl">
        <div class="accordion faq-accordion" id="faqAccordion">
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse1" class="accordion-collapse collapse show" aria-labelledby="faqHead1"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Yes, absolutely! At Your PC, we offer a wide range of components that you can use to customize
                        your own PC build. Our website makes it easy to browse our selection of components, including
                        CPUs, graphics cards, motherboards, RAM, storage drives, power supplies, and more.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse2" class="accordion-collapse collapse" aria-labelledby="faqHead2"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Yes! Our smart recommendation system can guide you through selecting the ideal, compatible parts
                        based on your specific budget and intended usage.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse3" class="accordion-collapse collapse" aria-labelledby="faqHead3"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        To build a complete PC, you typically need a Processor (CPU), Motherboard, Memory (RAM), Storage
                        (SSD or HDD), Graphics Card (GPU) (unless the CPU has integrated graphics), Power Supply Unit
                        (PSU), and a Case to house it all.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse4" class="accordion-collapse collapse" aria-labelledby="faqHead4"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Yes, all components and pre-built systems come with official manufacturer warranties, and our
                        customer support team is available to assist you with any warranty claims.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse5" class="accordion-collapse collapse" aria-labelledby="faqHead5"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        We offer free standard delivery across major cities in Bangladesh, with typical shipping times
                        ranging from 2 to 5 business days depending on your location.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse6" class="accordion-collapse collapse" aria-labelledby="faqHead6"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Yes! We run regular promotional offers, discount packages for full builds, and cash-back deals
                        during festive seasons. Check our store or sign up to stay updated.
                    </div>
                </div>
            </div>
...
<section class="about-us-section py-5" id="about-us"
    style="background: var(--bg-body); border-top: 1px solid var(--border);">
    <div class="container-xl text-center mb-5">
        ...
        <h2>Meet Our Team</h2>
        <p class="section-sub text-muted mx-auto" style="max-width: 600px;">The innovators driving the future of custom
            PC building in Bangladesh.</p>
    </div>

    <div class="container-xl">
        <div class="row g-4 justify-content-center">
            <div class="col-md-4">
                <div class="card floating-widget-card border-0 p-4 text-center h-100"
                    style="background: var(--bg-card); border: 1px solid var(--border) !important; backdrop-filter: blur(16px);">
                    <div class="d-flex justify-content-center mb-4">
                        <div class="avatar-circle-lg"
                            style="width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-family: var(--font-head); font-size: 1.8rem; font-weight: 800; background: linear-gradient(135deg, var(--accent) 0%, #3b82f6 100%);">
                            SS
                        </div>
                    </div>
                    <h3 class="fw-bold mb-1 h5">Shadman Ahammad Shanto</h3>
                    <span class="badge bg-accent-soft text-accent mb-3 px-3 py-2 rounded-pill fw-bold"
                        style="font-size: 0.75rem;">Founder and CEO</span>
                    <p class="text-muted small mb-0">Directs the overall vision, business strategy, and operations of
                        PCBuilder BD.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card floating-widget-card border-0 p-4 text-center h-100"
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <div class="avatar-circle-lg"
                            style="width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-family: var(--font-head); font-size: 1.8rem; font-weight: 800; background: linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%);">
                            SMS
                        </div>
                    </div>
                    <h3 class="fw-bold mb-1 h5">Shah Mohammed Seaman</h3>
                    <span class="badge bg-accent-soft text-accent mb-3 px-3 py-2 rounded-pill fw-bold"
                        style="font-size: 0.75rem; color: #3b82f6 !important; background: rgba(59, 130, 246, 0.1) !important;">CTO</span>
                    <p class="text-muted small mb-0">Architects the system codebase, chatbot engine, and compatibility
                        algorithms.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card floating-widget-card border-0 p-4 text-center h-100"
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <div class="avatar-circle-lg"
                            style="width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-family: var(--font-head); font-size: 1.8rem; font-weight: 800; background: linear-gradient(135deg, var(--accent) 0%, #84cc16 100%);">
                            JH
                        </div>
                    </div>
                    <h3 class="fw-bold mb-1 h5">Jim Hossain</h3>
                    <span class="badge bg-accent-soft text-accent mb-3 px-3 py-2 rounded-pill fw-bold"
                        style="font-size: 0.75rem; color: #10b981 !important; background: rgba(16, 185, 129, 0.1) !important;">Co
                        Founder and CFO</span>
                    <p class="text-muted small mb-0">Manages company finances, component pricing structures, and
                        analytics.</p>
                </div>
            </div>
        </div>
