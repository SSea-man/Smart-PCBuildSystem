...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with shadman1@pcbuild.com, fill the password field with pass1234, then click the 'Sign In' button to submit the form and verify landing on the authenticated dashboard.
