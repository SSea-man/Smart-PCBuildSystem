...
async def run_test():
    ...
    try:
        ...
        # -> Open the login page by clicking the 'Login' link in the top navigation.
        # link "Login"
        ...
        # -> Open the AI Chat / chatbot page by clicking the 'AI Chat' link in the top navigation.
        # link "AI Chat"
        elem = page.locator("xpath=/html/body/nav/div/div/ul/li[4]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Type a PC-building question into the chat input and send it.
        # text input aria-label="Chat message"
        elem = page.locator("xpath=/html/body/main/div/div[2]/div/div[2]/div[2]/div/input").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("What's the best gaming PC I can build in Bangladesh for \u09f380,000?")
        
        # -> Type a PC-building question into the chat input and send it.
        # button aria-label="Send message"
        elem = page.locator("xpath=/html/body/main/div/div[2]/div/div[2]/div[2]/div/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
