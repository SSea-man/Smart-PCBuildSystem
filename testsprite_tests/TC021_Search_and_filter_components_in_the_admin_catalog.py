...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Admin' link to open the admin components page (navigate to /myproject/admin/components.php).
        # link "Admin"
        elem = page.locator("xpath=/html/body/nav/div/div/ul/li[5]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Click the 'Manage Components' button/link to open the admin components management page (/myproject/admin/components.php). After the page loads, locate the search box and category filter to narrow the component list.
        ...
        assert '/admin/components.php' in current_url, "The page should have navigated to the components management page after opening Manage Components"
        assert await page.locator("xpath=//*[contains(., 'Manage Components')]").nth(0).is_visible(), "The component list should be narrowed and display Manage Components after performing the search and filter"
